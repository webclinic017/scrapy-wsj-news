...
def get_ucodes():
    codes = {
        # 新華富時A50
        '指數2': ['xin9x000'],
        # 華夏滬深300, 領航標普500, 盈富, 恒指ETF, 安碩恒生指數, 安碩A50, 南方A50, 安碩滬深300, 南方恒生科技, 恒生國指
        ...
        # 騰訊, 美團, 阿里, 京東, 藍月亮,, 泡泡瑪特, 網易, 快手, 京东健康, 海爾智家
        '新經濟': ['0700.HK', '3690.HK', '9988.HK', '9618.HK', '6993.HK', '9992.HK', '9999.HK', '1024.HK', '6618.HK', '6690.HK'],
        #
