...
def get_ucodes():
    codes = {
        # 騰訊, 美團, 阿里, 京東, 藍月亮,, 泡泡瑪特, 網易, 快手
        '新經濟': ['0700.HK', '3690.HK', '9988.HK', '9618.HK', '6993.HK', '9992.HK', '9999.HK', '1024.HK'],
        #
        ...
        '醫藥': ['2196.HK', '1093.HK', '1177.HK', '2359.HK', '1801.HK', '2269.HK', '3692.HK', '3759.HK', '0874.HK',
               '1099.HK',
               '1558.HK'],
        # 平安好醫生, 阿里健康, 微創醫療, 錦欣生殖, 威高, 春立, 金斯瑞, 康希諾
        '新醫療': ['1833.HK', '0241.HK', '0853.HK', '1951.HK', '1066.HK', '1858.HK', '1548.HK', '6185.HK'],
        # 匯控, 中行, 渣打, 恆生
        ...
        # 海螺創業, 創科實業
        '實業': ['0586.HK', '0669.HK'],
        # 華夏滬深300, 領航標普500, 盈富, 恒指ETF, 安碩恒生指數, 安碩A50, 南方A50, 安碩滬深300
        '指數ETF': ['3188.HK', '9140.HK', '2800.HK', '2833.HK', '3115.HK', '2823.HK', '2822.HK', '2846.HK'],
